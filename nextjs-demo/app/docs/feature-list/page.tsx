...
export default function FeatureListPage() {
  return (
    <DocPage
      title="Feature List"
      description="A responsive grid of feature cards for showcasing product highlights. Each card has an icon container with color variants, a heading, and a description. Cards lift on hover with a purple border glow."
      source="components/feature-list.css"
      table={[
        { class: 'vel-features', properties: 'section wrapper — padding: 16 (vertical) and 6 (horizontal)' },
        { class: 'vel-features-grid', properties: 'CSS grid with auto-fill columns, minmax(280px, 1fr), gap: 6' },
        { class: 'vel-feature-card', properties: 'flex column, surface-2 bg, border, border-radius: 2xl, hover: translateY(-4px) + shadow-xl + primary border' },
        { class: 'vel-feature-icon', properties: '3rem square icon container, border-radius: xl, default primary bg tint' },
        { class: 'vel-feature-icon-primary', properties: 'primary bg tint, primary-400 icon color' },
        { class: 'vel-feature-icon-success', properties: 'green bg tint, success-400 icon color' },
        { class: 'vel-feature-icon-info', properties: 'cyan bg tint, info-400 icon color' },
        { class: 'vel-feature-icon-danger', properties: 'red bg tint, danger-400 icon color' },
        { class: 'vel-feature-icon-warning', properties: 'amber bg tint, warning-400 icon color' },
        { class: 'vel-feature-title', properties: 'lg font-size, semibold, color: text, margin: 0, snug line-height' },
        { class: 'vel-feature-text', properties: 'base font-size, color: muted, relaxed line-height, margin: 0' },
      ]}
      examples={[
        {
          label: 'Three feature cards with different icon colors',
  ...
  <div class="vel-features-grid" style="padding:0;">
    ...
    <div class="vel-feature-card">
      ...
      <p class="vel-feature-text">Every value is a CSS custom property. Override the entire system with a single token swap.</p>
        ...
        {
          label: 'Feature cards with warning and danger icon variants',
          html: `<div style="padding:24px;background:#060b17;font-family:system-ui,sans-serif;border-radius:12px;">
  <div class="vel-features-grid" style="padding:0;">
    <div class="vel-feature-card">
